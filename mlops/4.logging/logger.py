...
if __name__ == "__main__":
    ...
    logger = get_ml_logger(
        ...
        credential_json_path="/Users/jaykim/Downloads/tigiminishgt-se-bigquery-sa.json",  # FIXME
        table_ref="tigiminishgt.online_serving_logs.mask_classification",  # FIXME: e.g., boostcamp-ai-tech-serving.online_serving_logs.mask_classification
    )
    for _ in range(10):
